...
var caseNumber = 0;
var wait = 24; //chodzenie
var wait2 =24; //chodzenie
var czekajpvp=90; //czeka po przejściu
var czekajka=90; // bicie fragów
var czekaj=90; // bicie fragów nr2
var licznik=0;
var antybot=false
var stop = true;
var dogory=false;
...
{
 if(parseInt($('#clan_war_cnt').text()) < 21){
            GAME.emitOrder({a:39,type:24,shorts:"fdsfsd;DK;Say;Ssc;ZSCH;BDS;gimme;PAKT;Soul;JSKA;DARK;Shadow;MoOEn;MWars;LWDB;GM;FRSPG;Saiyan;UVM;Ramizb;ZONG"});
        }	kom_clear();
...
function kill_players(){
    $("button.more_players.poption").click()
    if(licznik==15){
    window.setTimeout(start,czekaj);
    licznik=0;}
        else if(licznik<document.getElementById("player_list_con").childElementCount){
            //if(document.getElementById("player_list_con").childElementCount>5){
            //czekajpvp=150;}
            //else {czekajpvp=300;}
